...
export default class Physics {
    constructor() {
        ...
        // Robot vs cualquier objeto del nivel (defaultMaterial)
        const robotDefaultContact = new CANNON.ContactMaterial(
            this.robotMaterial,
            this.defaultMaterial,
            {
                friction: 0.0,
        ...
        this.world.addContactMaterial(robotDefaultContact)
